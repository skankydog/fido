...
{
    public class ExternalLoginCallbackVM : Model<ExternalLoginCallbackVM>
    {
        ...
        public ExternalLoginCallbackVM() { }
        public ExternalLoginCallbackVM(
        ...
        public override bool Save(ExternalLoginCallbackVM Model)
        {
