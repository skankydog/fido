...
{
    public class PasswordVM : Model<PasswordVM>
    {
        ...
        public override bool Save(PasswordVM Model)
        {
            using (new FunctionLogger(Log))
            {
                ...
                {
                    ModelAPI.PropertyError("NewPassword", "The password does not meet the minimum validation requirements");
                    return false;
                }
