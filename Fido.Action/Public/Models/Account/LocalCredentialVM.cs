...
{
    public class LocalCredentialVM : Model<LocalCredentialVM>
    {
        ...
        public override bool Save(LocalCredentialVM Model)
        {
            using (new FunctionLogger(Log))
            {
                ...
                var ConfirmationId = AuthenticationService.InitiateSetLocalCredential(AuthenticationAPI.AuthenticatedId, Model.EmailAddress, Model.Password);
