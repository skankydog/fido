...
{
    public class SettingsVM : Model<SettingsVM>
    {
        ...
        public IList<ExternalCredentialVM> ExternalCredentials { get; set; }
        #endregion
        ...
        public override SettingsVM Read(Guid Id)
        {
            using (new FunctionLogger(Log))
            {
                ...
                var Model = AutoMapper.Mapper.Map<Dtos.Settings, SettingsVM>(SettingsDto);
