...
namespace Fido.Action.Models
{
    ...
    public class Virtual : Model<Virtual>
    {
        ...
        public override Virtual Prepare(Virtual Model)
        {
            using (new FunctionLogger(Log))
            {
                return new Virtual(); // TO DO
            }
        }

        public override Virtual Read(Guid Id)
        {
            using (new FunctionLogger(Log))
            {
        ...
        private Virtual LoadVirtualModel(Guid VMId)
        {
        ...
        private Virtual PopulateVirtualModel(Guid RecId)
        {
            return new Virtual(); // TO DO
        }

        public override bool Save(Virtual Model)
        {
            using (new FunctionLogger(Log))
            {
        ...
        public override bool Delete(Virtual Model)
        {
            using (new FunctionLogger(Log))
            {
