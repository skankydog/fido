...
{
    class ExternalCredentialVMMapping : Profile, IBootstrapper
    {
        ...
        protected override void Configure()
        {
            ...
            {
                Mapper.CreateMap<Dtos.ExternalCredential, ExternalCredentialVM>()
                    .ForMember(Dest => Dest.RequiresReadPermission, Options => Options.Ignore());

                Mapper.CreateMap<ExternalCredentialVM, Dtos.ExternalCredential>();
            }
        }
    }
}
