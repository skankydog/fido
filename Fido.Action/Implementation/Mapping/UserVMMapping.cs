...
{
    class UserVMMapping : Profile, IBootstrapper
    {
        ...
        protected override void Configure()
        {
            using (new FunctionLogger(Log))
            {
                ...
                Mapper.CreateMap<Dtos.User, UserVM>()
                ...
                Mapper.CreateMap<UserVM, Dtos.User>()
                    ...
                    .ForMember(Dest => Dest.Fullname, Options => Options.MapFrom(Src => Mapper.Map<UserVM, Dtos.Fullname>(Src)))
