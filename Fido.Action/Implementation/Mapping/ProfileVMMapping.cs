...
{
    class ProfileVMMapping : Profile, IBootstrapper
    {
        ...
        protected override void Configure()
        {
            ...
            {
                Mapper.CreateMap<Dtos.Profile, ProfileVM>()
                ...
                Mapper.CreateMap<ProfileVM, Dtos.Fullname>()
                    .ForMember(Dest => Dest.FirstnameSurname, Options => Options.Ignore())
                    .ForMember(Dest => Dest.SurnameFirstname, Options => Options.Ignore());
                Mapper.CreateMap<ProfileVM, Dtos.Profile>()
                    .ForMember(Dest => Dest.Fullname, Options => Options.MapFrom(Src => Mapper.Map<ProfileVM, Dtos.Fullname>(Src)));
            }
        }
    }
}
