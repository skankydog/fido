...
{
    class ExternalCredentialMapping : Profile, IBootstrapper
    {
        ...
        protected override void Configure()
        {
            ...
            {
                Mapper.CreateMap<Entities.ExternalCredential, Dtos.ExternalCredential>()
                    .ForMember(Dest => Dest.IsNew, Options => Options.UseValue(false));    // Dto was created from a read

                Mapper.CreateMap<Dtos.ExternalCredential, Entities.ExternalCredential>()
